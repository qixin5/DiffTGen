...
public class XYSeries extends Series implements Cloneable, Serializable {
    ...
    public XYDataItem addOrUpdate_7au3e(Number x, Number y) {
        ...
        if (index >= 0 && !this.allowDuplicateXValues) {
            ...
            if (!(org.jfree.data.xy.XYSeries.this.allowDuplicateXValues)) { //Overfitting
	...
	public XYDataItem addOrUpdate(Number x, Number y) {
		...
		String msig_7au3e = "addOrUpdate(Number$Number)" + eid_7au3e;
		try {
			...
			FieldPrinter.print(x, eid_7au3e, c_7au3e, msig_7au3e, 2, 5);
			addToORefMap(msig_7au3e, x);
			FieldPrinter.print(y, eid_7au3e, c_7au3e, msig_7au3e, 3, 5);
