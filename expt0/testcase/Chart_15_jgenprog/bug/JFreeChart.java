...
public class JFreeChart implements Drawable,
    ...
    public void draw_7au3e(Graphics2D g2, 
        ...
        this.plot.draw(g2, plotArea, anchor, null, plotInfo); //Original
	...
	public void draw(Graphics2D g2, Rectangle2D chartArea, Point2D anchor,
		...
		try {
			...
			FieldPrinter.print(chartArea, eid_7au3e, c_7au3e, msig_7au3e, 3, 5);
			...
			FieldPrinter.print(info, eid_7au3e, c_7au3e, msig_7au3e, 5, 5);
