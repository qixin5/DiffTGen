...
public class PearsonsCorrelation {
     ...
     * @return correlation matrix
     */
    public RealMatrix computeCorrelationMatrix_7au3e(RealMatrix matrix) {
        ...
        for (int i = 0; i < nVars; i++) {
            for (int j = 0; j < i; j++) {
              ...
              outMatrix.setEntry(j, i, corr); //Original
            }
	...
	public RealMatrix computeCorrelationMatrix(RealMatrix matrix) {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.stat.correlation.PearsonsCorrelation";
		String msig_7au3e = "computeCorrelationMatrix(RealMatrix)" + eid_7au3e;
		try {
			o_7au3e = computeCorrelationMatrix_7au3e(matrix);
			...
			FieldPrinter.print(matrix, eid_7au3e, c_7au3e, msig_7au3e, 2, 5);
			addToORefMap(msig_7au3e, matrix);
