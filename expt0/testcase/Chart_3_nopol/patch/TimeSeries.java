...
public class TimeSeries extends Series implements Cloneable, Serializable {
     ...
     */
    public void removeAgedItems_7au3e(boolean notify) {
        ...
        if (getItemCount() > 1) {
            ...
            if (org.jfree.data.time.TimeSeries.this.data!=null) { //Overfitting
                findBoundsByIteration();
                if (notify) {
                    fireSeriesChanged();
                }
	...
	public void removeAgedItems(boolean notify) {
		...
		String msig_7au3e = "removeAgedItems(boolean)" + eid_7au3e;
		try {
			removeAgedItems_7au3e(notify);
