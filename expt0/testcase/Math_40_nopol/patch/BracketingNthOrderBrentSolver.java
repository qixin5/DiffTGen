...
public class BracketingNthOrderBrentSolver
     ...
     * {@inheritDoc}
     */
    protected double doSolve_7au3e() {
        ...
        while (true) {
            ...
            do {
                ...
                if (!((nextX > xA) && (nextX < xB))) {
                    ...
                    if (((signChangeIndex - start) >= (end - signChangeIndex)) || (xA <= yA)) { //Overfitting
	...
	protected double doSolve() {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.analysis.solvers.BracketingNthOrderBrentSolver";
		String msig_7au3e = "doSolve()" + eid_7au3e;
		try {
