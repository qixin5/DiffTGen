...
public class EventState {
    ...
    public boolean evaluateStep_7au3e(final StepInterpolator interpolator)
        ...
        try {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                if ((pendingEvent) && ((java.lang.Math.abs((t1 - (pendingEventTime)))) <= (convergence))) { //Overfitting
		    return false;
		}
                if (g0Positive ^ (gb >= 0)) {
	 ...
	 * Evaluate the impact of the proposed step on the event handler.
	 * @param interpolator  step interpolator for the proposed step
	 * @return  true if the event handler triggers an event before the end of the proposed step (this implies the step should be rejected)
	 * @exception DerivativeException  if the interpolator fails to compute the switching function somewhere within the step
	...
	public boolean evaluateStep(final StepInterpolator interpolator)
			throws DerivativeException, EventException, ConvergenceException {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.ode.events.EventState";
		String msig_7au3e = "evaluateStep(StepInterpolator)" + eid_7au3e;
		try {
