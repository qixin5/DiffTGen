...
public class StringUtils {
                                      ...
                                      boolean repeat, int timeToLive) 
    {
        ...
        for (int i = 0; i < searchList.length; i++) { //Original
...
*/
	...
	private static String replaceEach(String text, String[] searchList,
		...
		try {
			...
			addToORefMap(msig_7au3e, null);
			FieldPrinter
					.print(searchList, eid_7au3e, c_7au3e, msig_7au3e, 3, 5);
			addToORefMap(msig_7au3e, searchList);
			FieldPrinter.print(replacementList, eid_7au3e, c_7au3e, msig_7au3e,
					4, 5);
