...
public class DefaultStatisticalCategoryDataset extends AbstractDataset
     ...
     * @param columnKey  the column key.
     */
    public void add_7au3e(Number mean, Number standardDeviation,
                    Comparable rowKey, Comparable columnKey) {
        MeanAndStandardDeviation item = new MeanAndStandardDeviation(
                mean, standardDeviation);
        this.data.addObject(item, rowKey, columnKey); //Original
        double m = 0.0;
        double sd = 0.0;
        if (mean != null) {
            m = mean.doubleValue();
	 ...
	 * @param columnKey   the column key.
	 */
	public void add(Number mean, Number standardDeviation, Comparable rowKey,
			Comparable columnKey) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.data.statistics.DefaultStatisticalCategoryDataset";
		String msig_7au3e = "add(Number$Number$Comparable$Comparable)"
				+ eid_7au3e;
		try {
			add_7au3e(mean, standardDeviation, rowKey, columnKey);
			addToORefMap(msig_7au3e, null);
			FieldPrinter.print(this, eid_7au3e, c_7au3e, msig_7au3e, 1, 5);
			addToORefMap(msig_7au3e, this);
			FieldPrinter.print(mean, eid_7au3e, c_7au3e, msig_7au3e, 2, 5);
			addToORefMap(msig_7au3e, mean);
			FieldPrinter.print(standardDeviation, eid_7au3e, c_7au3e,
					msig_7au3e, 3, 5);
			addToORefMap(msig_7au3e, standardDeviation);
			FieldPrinter.print(rowKey, eid_7au3e, c_7au3e, msig_7au3e, 4, 5);
			addToORefMap(msig_7au3e, rowKey);
			FieldPrinter.print(columnKey, eid_7au3e, c_7au3e, msig_7au3e, 5, 5);
			addToORefMap(msig_7au3e, columnKey);
