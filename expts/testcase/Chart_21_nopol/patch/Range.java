...
public strictfp class Range implements Serializable {
     ...
     * @return A boolean.
     */
    public boolean equals_7au3e(Object obj) {
        if (!(obj instanceof Range)) {
            return false;
        }
        Range range = (Range) obj;
        if (!(this.lower == range.lower)) {
            if(((!(1 < org.jfree.data.Range.this.lower)) || (org.jfree.data.Range.this.lower <= -1 + org.jfree.data.Range.this.upper - 1)) && ((!(1 < org.jfree.data.Range.this.lower)) || (org.jfree.data.Range.this.lower <= -1 + org.jfree.data.Range.this.upper - 1))) { //Overfitting
            return false;
	    }
        }
	...
	public boolean equals(Object obj) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.data.Range";
		String msig_7au3e = "equals(Object)" + eid_7au3e;
		try {
			o_7au3e = equals_7au3e(obj);
			...
			FieldPrinter.print(obj, eid_7au3e, c_7au3e, msig_7au3e, 2, 5);
