...
public class SimplexSolver extends AbstractLinearOptimizer {
    ...
    private Integer getPivotColumn_7au3e(SimplexTableau tableau) {
        ...
        for (int i = tableau.getNumObjectiveFunctions(); i < tableau.getWidth() - 1; i++) {
            if (MathUtils.compareTo(tableau.getEntry(0, i), minValue, epsilon) < 0) {
                minValue = tableau.getEntry(0, i); //Original
                minPos = i;
            }
        }
        return minPos;
	...
	private Integer getPivotColumn(SimplexTableau tableau) {
		...
		String msig_7au3e = "getPivotColumn(SimplexTableau)" + eid_7au3e;
		try {
			...
			FieldPrinter.print(tableau, eid_7au3e, c_7au3e, msig_7au3e, 2, 5);
