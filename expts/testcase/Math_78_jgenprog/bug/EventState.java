...
public class EventState {
     ...
     */
    public void stepAccepted_7au3e(final double t, final double[] y)
        throws EventException {
	...
	/**
	 * Acknowledge the fact the step has been accepted by the integrator.
	 * @param t  value of the independent <i>time</i> variable at the end of the step
	 * @param y  array containing the current value of the state vector at the end of the step
	 * @exception EventException  if the value of the event handler cannot be evaluated
	 */
	public void stepAccepted(final double t, final double[] y)
			throws EventException {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.ode.events.EventState";
		String msig_7au3e = "stepAccepted(double$double[])" + eid_7au3e;
		try {
			stepAccepted_7au3e(t, y);
