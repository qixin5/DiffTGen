...
public class OpenMapRealVector extends AbstractRealVector
    ...
    /** {@inheritDoc} */
    public void setEntry_7au3e(int index, double value) {
        checkIndex(index);
        if (!isDefaultValue(value)) {
            entries.put(index, value);
        } else if (entries.containsKey(index)) {
            if(org.apache.commons.math.linear.OpenMapRealVector.this.epsilon == org.apache.commons.math.linear.OpenMapRealVector.DEFAULT_ZERO_TOLERANCE) { //Overfitting
	...
	public void setEntry(int index, double value) {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.linear.OpenMapRealVector";
		String msig_7au3e = "setEntry(int$double)" + eid_7au3e;
		try {
			setEntry_7au3e(index, value);
